...
Source0  : https://files.pythonhosted.org/packages/db/4d/3970183622f0330d3c23d9b8a5f52e365e50381fd484d08e3285104333d3/anyio-4.3.0.tar.gz
...
%prep
%setup -q -n anyio-4.3.0
cd %{_builddir}/anyio-4.3.0
pushd ..
cp -a anyio-4.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708362991
