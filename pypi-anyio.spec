...
Source0  : https://files.pythonhosted.org/packages/f6/40/318e58f669b1a9e00f5c4453910682e2d9dd594334539c7b7817dabb765f/anyio-4.7.0.tar.gz
...
%prep
%setup -q -n anyio-4.7.0
cd %{_builddir}/anyio-4.7.0
pushd ..
cp -a anyio-4.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735093444
