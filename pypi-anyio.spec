...
Source0  : https://files.pythonhosted.org/packages/95/7d/4c1bd541d4dffa1b52bd83fb8527089e097a106fc90b467a7313b105f840/anyio-4.9.0.tar.gz
...
%prep
%setup -q -n anyio-4.9.0
cd %{_builddir}/anyio-4.9.0
pushd ..
cp -a anyio-4.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742441796
