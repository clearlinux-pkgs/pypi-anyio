...
Source0  : https://files.pythonhosted.org/packages/e6/e3/c4c8d473d6780ef1853d630d581f70d655b4f8d7553c6997958c283039a2/anyio-4.4.0.tar.gz
...
%prep
%setup -q -n anyio-4.4.0
cd %{_builddir}/anyio-4.4.0
pushd ..
cp -a anyio-4.4.0 buildavx2
popd
