...
Source0  : https://files.pythonhosted.org/packages/a0/44/66874c5256e9fbc30103b31927fd9341c8da6ccafd4721b2b3e81e6ef176/anyio-4.5.0.tar.gz
...
%prep
%setup -q -n anyio-4.5.0
cd %{_builddir}/anyio-4.5.0
pushd ..
cp -a anyio-4.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726744471
